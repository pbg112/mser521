...
const students = [
  { name: 'Alice', age: 20, grade: 85 }, // rows in a spreadsheet
...
// Your code here
const grade = students.map(row => row.grade)
console.log(grade)
...
// Your code here
const gradename = students.map(row => "Name: " + row.name + ','+ "Grade:" + row.grade)
...
// Your code here
const studentsMinusage = students.map( row => {name: row.name + grade: row.name})
console.log(studnetsMinusage); 
